...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.behaviors.bootstrapPopovers = {
    attach: function (context) {
      if (drupalSettings.mbase && drupalSettings.mbase.popoverEnabled) {
        var $currentPopover = $();
        if (drupalSettings.mbase.popoverOptions.triggerAutoclose) {
        ...
        for (var i = 0; i < elements.length; i++) {
          ...
          var options = $.extend({}, drupalSettings.mbase.popoverOptions, $element.data());
          if (!options.content) {
  ...
  Drupal.behaviors.bootstrapTooltips = {
    attach: function (context) {
      if (drupalSettings.mbase && drupalSettings.mbase.tooltipEnabled) {
